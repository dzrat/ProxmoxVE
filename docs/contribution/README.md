...
```bash
# 1. Fork on GitHub
# Visit: https://github.com/dzrat/ProxmoxVE → Fork (top right)
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/dzrat/ProxmoxVE/main/ct/myapp.sh)"
...
git remote add upstream https://github.com/dzrat/ProxmoxVE.git
...
- **GitHub**: [community-scripts/ProxmoxVE](https://github.com/dzrat/ProxmoxVE)
- **Issues**: [GitHub Issues](https://github.com/dzrat/ProxmoxVE/issues)
- **Discussions**: [GitHub Discussions](https://github.com/dzrat/ProxmoxVE/discussions)
