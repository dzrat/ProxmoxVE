...
# upstream   https://github.com/dzrat/ProxmoxVE.git (fetch)
# upstream   https://github.com/dzrat/ProxmoxVE.git (push)
```
...
print_info "Upstream: https://github.com/dzrat/ProxmoxVE"
echo ""
